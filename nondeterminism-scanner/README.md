...
the self-scan target has 185) should not make the whole run's exit code and
...
over-fires on would be a worse outcome than dating it. But it is dated:
  ...
  * The current report has **not** been re-triaged finding by finding.
    Nothing below should be read as a judgement about the 423
